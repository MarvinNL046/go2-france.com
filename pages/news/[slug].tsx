...
export default function NewsArticlePage({ article }: NewsArticlePageProps) {
  ...
  const jsonLd = {
    ...
    author: { '@type': 'Organization', name: 'Go2France' },
    publisher: {
      '@type': 'Organization',
      name: 'Go2France',
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://go2-france.com/news/${article.slug}/`,
    },
  };
  ...
  return (
    <>
      <SEOHead
        title={`${article.title} | France News — Go2France`}
        description={article.description}
      >
        <script
      ...
      <div className="bg-surface-cream min-h-screen">
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <footer className="mt-12 pt-8 border-t border-gray-200">
            ...
            >
              &larr; {isNl ? 'Terug naar France Nieuws' : 'Back to France News'}
            </Link>
          </footer>
        </article>
      </div>
